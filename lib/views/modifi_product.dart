...
class _ModifyProductState extends State<ModifyProduct> {
    ...
    if (image != null) {
      ...
      setState(() {
        if (res != null) {
          ...
          print("Đã đặt đường dẫn ảnh: ${res} : ${imageController.text}");
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(productId.isNotEmpty ? "Cập nhật sản phẩm" : "Thêm sản phẩm"),
      ),
              ...
              children: [
                ...
                SizedBox(
                    ...
                    child: ElevatedButton(
                        ...
                        child: Text(productId.isNotEmpty ? "Cập nhật sản phẩm" : "Thêm sản phẩm"))),
              ],
            ),
          ),
        ),
